...
이 언어를 어떤 커뮤니티가 만들고 있는 것인지 대체로 관심이 없는 것 같지만

정원을 가꾸는 정원사의 마음으로 가볍고 유쾌하게 이 책을 넘겨 보면 괜찮을 것 같다.
...
줄리아는 교수, 박사, 연구자, 수학자, 물리학자, 바이오, 통계학, 금융업, 펀드 투자, 데이터 분석, 머신러닝 등등의 분야에서 현재 쓰이고 있다.
